...
(async () => {
  ...
  try {
    ...
    if (alreadyRunning) {
      console.log('Backend already running on port 3001, reusing it...');
    } else {
      console.log('Starting backend server for E2E...');
    ...
    await runNode(path.join(rootDir, 'test', 'e2e.js'), rootDir);
